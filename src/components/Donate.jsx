  ...
  return (
    <section id="donate" className="w-full bg-black z-[2] relative py-32 max-lg:py-10 text-white">
      <div className="w-full max-w-[1560px] mx-auto px-6 flex flex-col items-center text-center z-10 px-4">
        {/* Main Title */}
        <h1 className="text-white text-[50px] md:text-[60px] georgia-pro-light leading-[1] [text-shadow:0_0_10px_rgba(255,255,255,0.8)] tracking-[-0.02em] mb-2">
          <span className="italic">Get</span> in touch with us
        </h1>
